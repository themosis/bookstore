...
abstract class MetaboxTemplate
{
	...
	*/
	...
	/**
	 * Output the <input type="password" /> tag template.
	 *
	 * @param array
	*/
	protected static function password($field)
	{
		?>
			...
			<tr class="themosis-field-container">
				...
				<td>
					<input type="password" name="<?php echo($field['name']); ?>" data-type="text" class="large-text" id="<?php echo($field['name']); ?>-id" value="<?php echo($field['value']); ?>" />
					<?php if ($field['info']) : ?>
						<div class="themosis-field-info">
							<p><?php echo($field['info']); ?></p>
						</div>
